...
public class WishlistController {
    ...
    public ResponseEntity<BaseResponse<WishlistResponseDto>> saveWishlist(@PathVariable Long contentId, @AuthenticationPrincipal CustomMemberDetails customMemberDetails) {

        WishlistResponseDto wishlistResponseDto = wishlistService.saveWishlist(contentId, customMemberDetails.getMemberId());
    ...
    public ResponseEntity<BaseResponse<Page<WishlistResponseDto>>> listAll(@AuthenticationPrincipal CustomMemberDetails customMemberDetails, @ParameterObject @PageableDefault(size = 10, page = 0) Pageable pageable) {

        Page<WishlistResponseDto> wishlists = wishlistService.getWishlist(customMemberDetails.getMemberId(), pageable);
